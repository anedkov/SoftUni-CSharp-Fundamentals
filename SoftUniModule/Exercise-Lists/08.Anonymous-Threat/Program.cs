    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            while (command != "3:1")
            {
                ...
                if (tokens[0] == "merge")
                {
                    Merging(input, tokens);
                }
                else if (tokens[0] == "divide")
                {
                    Dividing(input, tokens);
                }
        ...
        private static void Merging(List<string> input, List<string> tokens)
        {
        ...
        private static void Dividing(List<string> input, List<string> tokens)
        {
            List<string> temp = new List<string>();
