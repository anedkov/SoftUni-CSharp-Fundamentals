...
namespace MiniORM
{
        ...
        where T : class, new()
    {
        ...
        public ChangeTracker(IEnumerable<T> entiities)
        {
            this.added = new List<T>();
            this.removed = new List<T>();

            this.allEntities = CloneEntitites(entiities);
        }

        public IReadOnlyCollection<T> AllEntites =>
        ...
        public IEnumerable<T> GetModifiedEntities(DbSet<T> dbSet)
        {
            ...
            PropertyInfo[] primaryKeys = typeof(T)
                ...
                ())
                .ToArray();
            foreach (T proxyEntity in this.AllEntites)
            {
                ...
                T entity = dbSet
                    ...
                    .SequenceEqual(primaryKeyValues)); // returns first
        ...
        private static bool IsModified(T proxyEntity, T entity)
        {
            PropertyInfo[] monitoredProperties = typeof(T)
                                   ...
                                   .ToArray();
            PropertyInfo[] modifedProperties = monitoredProperties
                .Where(pi => !Equals(pi.GetValue(entity)
                , pi.GetValue(proxyEntity)))
                .ToArray();

            return modifedProperties.Any();
        }
